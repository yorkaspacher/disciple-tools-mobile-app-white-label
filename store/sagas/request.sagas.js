// adapted from:
//   -- http://www.youtube.com/watch?v=Pg7LgW3TL7A
//   -- http://redux-saga.js.org/docs/advanced/Channels.html
...
function* processRequest(request) {
  ...
  if (
    requestCopy.data.body &&
    Object.prototype.toString.call(requestCopy.data.body) === '[object Object]'
  ) {
...
export default function* requestSaga() {
  ...
  while (true) {
    ...
    if (!isConnected || localGetById.isLocal) {
      ...
      let requestIndex;
      if (
        request.payload.data.method === 'POST' &&
        Object.prototype.toString.call(request.payload.data.body) === '[object Object]'
      ) {
