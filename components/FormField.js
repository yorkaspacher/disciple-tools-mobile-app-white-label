...
class FormField extends PureComponent {
  render = () => {
    const { containerStyle, iconStyle, labelStyle, iconName, inline, label, iconType } = this.props;
    ...
    return (
      <View style={[styles.containerStyle, containerStyle]}>
        <Row style={styles.formRow}>
          <Col style={styles.formIconLabel}>{icon}</Col>
          <Col>
            <Col style={{ alignSelf: 'stretch', justifyContent: 'center' }}>
              <View style={styles.formText}>{inlineContent}</View>
            </Col>
          </Col>
