...
const initialState = {
  ...
  executingBack: false,
  iconQuantity: 0,
  customFielGroupPluginActive: false,
  influenceValue: 0,
  partnerInvolvement: '',
  leastReachedCategory: '',
...
class GroupDetailScreen extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (savedShare && prevProps.savedShare !== savedShare) {
      ...
      toastSuccess.show(
        <View>
          <Text style={{ color: styles.successColor.backgroundColor }}>
    ...
    if (usersError || groupsError) {
      ...
      toastError.show(
        <View>
          <Text style={{ fontWeight: 'bold', color: styles.dangerColor.backgroundColor }}>
            {i18n.t('global.error.code')}
          </Text>
          <Text style={{ color: styles.dangerColor.backgroundColor }}>{error.code}</Text>
          <Text style={{ fontWeight: 'bold', color: styles.dangerColor.backgroundColor }}>
            {i18n.t('global.error.message')}
          </Text>
          <Text style={{ color: styles.dangerColor.backgroundColor }}>{error.message}</Text>
        </View>,
        3000,
      );
    }
  ...
  onRefresh(groupId, forceRefresh = false) {
    if (!self.state.loading || forceRefresh) {
      this.setState(
        ...
        () => {
          fetch(`http://${this.props.userData.domain}/wp-json/dt-public/dt-core/v1/settings`, {
            method: 'GET',
            headers: {
            ...
            .then((response) => {
              if (
                ...
                response.leastReachedCategoryValue == undefined ||
                response.partnerInvolvementValue == undefined
              ) {
                this.setState({
                  customFielGroupPluginActive: false,
                });
                ...
                this.setState({
                  customFielGroupPluginActive: true,
                });
              }

              if (response.sliderValue) {
                response.sliderValue.forEach((element) => {
                  if (element.post_id == this.props.navigation.state.params.groupId) {
                    this.setState({
                      influenceValue: +element.meta_value,
                    });
                  }
                });
              }

              if (response.leastReachedCategoryValue) {
                response.leastReachedCategoryValue.forEach((element) => {
                  if (element.post_id == this.props.navigation.state.params.groupId) {
                    this.setState({
                      leastReachedCategory: element.meta_value,
                    });
                  }
                });
              }

              if (response.partnerInvolvementValue) {
                response.partnerInvolvementValue.forEach((element) => {
                  if (element.post_id == this.props.navigation.state.params.groupId) {
                    this.setState({
                      partnerInvolvement: element.meta_value,
                    });
                  }
                });
              }
                    ...
                    parse={[
                      {
                        ...
                        style: { color: styles.primaryColor.backgroundColor },
                        ...
                        <Row
                          ...
                          <Row
                            ...
                            <Icon
                              ...
                              name="delete"
                              style={{
                                color: styles.dangerColor.backgroundColor,
                                fontSize: 20,
                              }}
                            />
                            <Text
          ...
          <TouchableOpacity
            ...
            <View
              ...
              <CheckBox
                ...
                checkedColor={styles.primaryColor.backgroundColor}
              />
            </View>
          </TouchableOpacity>
          <TouchableOpacity
        ...
        columnsByRow.push(
          <Col key={columnsByRow.length} size={5}>
            <TouchableOpacity
              ...
              activeOpacity={1}
              underlayColor={
                this.onCheckExistingHealthMetric(value)
                  ? styles.primaryColor.backgroundColor
                  : Colors.gray
              }
              style={{
                borderRadius: 10,
  ...
  setFieldContentStyle(field) {
    ...
    if (field.name == 'name' && this.state.nameRequired) {
      newStyles = {
        ...
        borderWidth: 2,
        borderColor: styles.dangerColor.backgroundColor,
      };
    }
    return newStyles;
  }
                ...
                <View key={index.toString()}>
                  ...
                  (field.type == 'connection' && field.post_type == 'groups') ? (
                    ...
                    <View>
                      ...
                      {field.name == 'tags' && this.state.customFielGroupPluginActive ? (
                        <View>
                          <Row style={{ paddingTop: 15 }} size={100}>
                            <Col size={100}>
                              <Label style={styles.formLabel}>
                                Influence: {this.state.influenceValue}
                              </Label>
                              <Slider
                                style={styles.colSlider}
                                maximumValue={100}
                                minimumValue={0}
                                value={this.state.influenceValue}
                                disabled={true}
                              />
                            </Col>
                          </Row>
                          ...
                          <Row style={{ paddingTop: 15 }} size={100}>
                            <Col size={100}>
                              <Label style={styles.formLabel}>Partner Involvement</Label>
                              <Label>
                                {this.state.partnerInvolvement == 'partners_available'
                                  ? 'A - No partners available'
                                  : this.state.partnerInvolvement == 'working_with_partners'
                          ...
                          <Row style={{ paddingTop: 15 }} size={100}>
                            <Col size={100}>
                              <Label style={styles.formLabel}>Least Reached Category</Label>
                              <Label>
                                {this.state.leastReachedCategory == 'no_witness'
                                  ? 'A - No witness'
                                  : this.state.leastReachedCategory == 'witness_but_no_community'
                                  ? 'B - Witness but no community'
                                  : 'C - Community but isolated'}
                              </Label>
                            </Col>
                          </Row>
                        </View>
                          ...
                          <View>
                              ...
                              <Col size={100}>
                                ...
                                <Slider
                                  ...
                                  onValueChange={(value) => {
                                    ...
                                    fetch(
                                      `http://${this.props.userData.domain}/wp-json/dt-posts/v2/groups/${this.props.navigation.state.params.groupId}`,
                                      {
                                        method: 'POST',
                                        headers: {
                                          'Content-Type': 'application/json',
                            ...
                            <Row style={{ paddingTop: 15 }} size={100}>
                              <Col size={100}>
                                <Label style={styles.formLabel}>Partner Involvement</Label>
                                <Picker
                                  selectedValue={this.state.partnerInvolvement}
                                  ...
                                  onValueChange={(itemValue, itemIndex) => {
                                    ...
                                    this.setState({
                                      partnerInvolvement: itemValue,
                                    });
                                  }}>
                                  <Picker.Item
                                    label="A - No partners available"
                                    value="partners_available"
                                  />
                                  <Picker.Item
                                    label="B - Working with partners"
                                    value="working_with_partners"
                                  />
                                  <Picker.Item
                                    label="C - Working separately"
                                    value="working_separately"
                                  />
                                </Picker>
                              </Col>
                            </Row>
                            ...
                            <Row style={{ paddingTop: 15 }} size={100}>
                              <Col size={100}>
                                <Label style={styles.formLabel}>Least Reached Category</Label>
                                <Picker
                                  selectedValue={this.state.leastReachedCategory}
                                  // style={{ height: 50, width: 150 }}
                                  onValueChange={(itemValue, itemIndex) => {
                                    fetch(
                                      `http://${this.props.userData.domain}/wp-json/dt-posts/v2/groups/${this.props.navigation.state.params.groupId}`,
                                      {
                                        ...
                                        body: JSON.stringify({
                                          least_reached_category: itemValue,
                                        }),
                                      },
                                    )
                                      .then(async (response) => {
                                    ...
                                    this.setState({
                                      leastReachedCategory: itemValue,
                                    });
                                  }}>
                                  <Picker.Item
                                    label="A - No witness; No response"
                                    value="no_witness"
                                  />
                                  <Picker.Item
                                    label="B - Witness but no community"
                                    value="witness_but_no_community"
                                  />
                                  <Picker.Item
                                    label="C - Community but isolated"
                                    value="community_but_isolated"
                                  />
                                </Picker>
                              </Col>
                            </Row>
  ...
  renderMultiSelectField = (field, value, index) => (
    <TouchableOpacity
      ...
      activeOpacity={1}
      underlayColor={
        this.onCheckExistingMilestone(value, field.name)
          ? styles.primaryColor.backgroundColor
          : Colors.gray
      }
      style={{
        ...
        if (field.name === 'group_status') {
          ...
          mappedValue = (
            <Picker
              ...
              textStyle={{ color: styles.primaryColor.backgroundColor }}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <TabView
                  ...
                  renderTabBar={(props) => (
                    <TabBar
                      ...
                      activeColor={styles.tabStyleTextColor.color}
                ...
                {this.state.onlyView &&
                  this.state.tabViewConfig.index != this.state.tabViewConfig.routes.length - 1 && (
                    <ActionButton
                      buttonColor={styles.actionButtom.backgroundColor}
                      renderIcon={(active) =>
                        active ? (
                          <Icon
                            type="MaterialCommunityIcons"
                      ...
                      <ActionButton.Item
                        buttonColor={styles.primaryColor.backgroundColor}
                        ...
                        size={40}
                        nativeFeedbackRippleColor="rgba(0,0,0,0)"
                        textStyle={{ color: styles.primaryColor.backgroundColor, fontSize: 15 }}
                      ...
                      <ActionButton.Item
                        buttonColor={styles.successColor.backgroundColor}
                      ...
                      <ActionButton.Item
                        buttonColor={styles.dangerColor.backgroundColor}
                        ...
                        <Grid>
                          ...
                          <Row style={{ height: 60 }}>
                            <Button
                              ...
                              <Text style={{ color: styles.primaryColor.backgroundColor }}>
                                {i18n.t('global.close')}
                              </Text>
                            </Button>
                            {this.state.commentDialog.delete ? (
                              <Button
                                block
                                style={[styles.dialogButton, styles.dangerColor.backgroundColor]}
                                onPress={() => {
