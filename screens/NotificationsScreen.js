...
function updateColors(
  ...
  let stylesObject = {
    ...
    errorBackground: { backgroundColor: dangerColor },
    backgroundColorOpacity: { backgroundColor: topbarColor + '50' },
    textColor: { color: topbarColor },
  };
...
class NotificationsScreen extends React.Component {
  ...
  renderRow = (notification) => {
    ...
    return (
      <View
        style={
          notification.is_new === '1' ? styles.backgroundColorOpacity : styles.backgroundColor
        }>
