      ...
      return (
        <View style={{ flex: 1 }}>
          <Text
            style={[
              {
                color: styles.fabButtonPrimary.backgroundColor,
                fontSize: 18,
                textAlign: 'left',
                fontWeight: 'bold',
                marginBottom: 20,
          ...
          <TouchableOpacity
            ...
            <View
              ...
              <CheckBox
                ...
                checkedColor={styles.fabButtonPrimary.backgroundColor}
              />
            </View>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          <View style={{ backgroundColor: Colors.mainBackgroundColor }}>
            ...
            <TouchableOpacity
              ...
              style={[
                ...
                this.state.loadComments ? { backgroundColor: '#e6e6e6' } : styles.fabButtonPrimary,
        ...
        columnsByRow.push(
          <Col key={columnsByRow.length} size={5}>
            <TouchableOpacity
              ...
              activeOpacity={1}
              underlayColor={
                this.onCheckExistingMilestone(value)
                  ? styles.fabButtonPrimary.backgroundColor
                  : Colors.gray
              }
              style={{
                borderRadius: 10,
        ...
        if (field.name === 'overall_status') {
          ...
          mappedValue = (
            <Picker
              ...
              textStyle={{ color: styles.fabButtonPrimary.backgroundColor }}>
              ...
              <View style={{ flex: 1 }}>
                ...
                {this.state.onlyView &&
                  this.state.tabViewConfig.index !== this.state.tabViewConfig.routes.length - 1 && (
                    <ActionButton
                      buttonColor={styles.actionButton.backgroundColor}
                      renderIcon={(active) =>
                        active ? (
                          <Icon
                            type="MaterialCommunityIcons"
                      ...
                      <ActionButton.Item
                        ...
                        size={40}
                        buttonColor={styles.fabButtonError.backgroundColor}
                        nativeFeedbackRippleColor="rgba(0,0,0,0)"
                        textStyle={{ color: styles.fabButtonPrimary.backgroundColor, fontSize: 15 }}
                      ...
                      <ActionButton.Item
                        ...
                        size={40}
                        buttonColor={styles.fabButtonSuccess.backgroundColor}
                        nativeFeedbackRippleColor="rgba(0,0,0,0)"
                        textStyle={{ color: styles.fabButtonPrimary.backgroundColor, fontSize: 15 }}
                        textContainerStyle={{ height: 'auto' }}>
                        <Icon
                      ...
                      <ActionButton.Item
                        ...
                        buttonColor={styles.fabButtonPrimary.backgroundColor}
                        size={40}
                        nativeFeedbackRippleColor="rgba(0,0,0,0)"
                        textStyle={{ color: styles.fabButtonPrimary.backgroundColor, fontSize: 15 }}
                        textContainerStyle={{ height: 'auto' }}>
